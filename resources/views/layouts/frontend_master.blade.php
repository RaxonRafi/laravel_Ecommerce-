...
<body>
    <div id="fb-root"></div>
   <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v13.0" nonce="Jd3W0sfg"></script>
                        ...
                        <div class="login-content">
                            ...
                            <form action="{{url('login')}}" method="POST">
                                ...
                                <div class="member-register">
                                    <p> Not a member? <a href="{{route('customer.register')}}"> Register now</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
